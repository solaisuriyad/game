...
- **Mountains** ring the town and the monster forest. They come in three sizes — **small hills**, **medium peaks**, and **towering giants**. Some peaks are **snow-capped** (with falling snow), and some have **waterfalls** pouring down one side into a pool.
...
> **Hosting a shared world:** anyone can run `node server.js` and open port 3000; friends connect to that address. Easiest online option: deploy to a free Node host (Render / Railway / Fly.io). Single-player always works with no setup.
...
**3D controls (Minecraft-style third-person):** **WASD** moves relative to where you look. **Move the mouse** to look around — moving it right turns the view right, left turns left (exactly like Minecraft), and moving up/down tilts the camera. **Scroll up** to look up at the sky (sun, moon, clouds) and **scroll down** to look back down. The camera sits at the player's level behind their back — and **when you fly, the camera flies up with you**. **Left-click** attacks where you look. **Esc** opens the menu. *(Opening a menu pauses the mouse/scroll so popups don't move the game behind them.)* Your **full HUD** (health/stamina/MP, gold, minimap, quests, prompts) is shown over the 3D view. **Entering a building shows its interior in 3D too** — every building is now furnished in 3D: counters, the NPCs who work there, weapon racks, armor mannequins, shelves, beds, sofas, fireplaces, school desks, market stalls, the stable's horses, and the temple's Shiva Lingam. Sleep at the inn to lie down in 3D. The 3D view is optimized to run smoothly (trees are thinned and only drawn near you). It follows the **day/night cycle** (skies darken at night, the sun becomes a moon) and **weather** (rain and storms show falling rain, fog densifies the air). In 3D you can see your **arrows and rocks flying**, **damage numbers**, **loot drops**, **corpses**, **traps**, and **gatherable resources** (herbs, mushrooms, berries, ore). **Monsters show their name and rank badge above them**, and NPCs show their names. **Characters are detailed and gender-distinct**: men have broad shoulders, trousers and short hair; women have a dress, slender build and long hair; children are smaller. Everyone has a **face** (eyes, nose, brows, mouth), **hands and feet**, and **walks with a swinging-arm animation**. **Villagers dress for their job** — guards wear helmets and breastplates, blacksmiths wear aprons, healers wear white robes, farmers wear straw hats. Menus are still 2D overlays.
